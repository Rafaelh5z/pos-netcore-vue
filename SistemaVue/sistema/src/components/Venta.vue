                      ...
                      >
                        <template slot="items" slot-scope="props">
                          <td class="justify-center layout px-0">
                            <v-icon @click="agregarDetalle(props.item)" small class="mr-2">add</v-icon>
                          </td>
        ...
        <v-dialog v-model="adModal" max-width="290">
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn v-if="adAccion==1" color="green darken-4" flat="flat" @click="activar">Activar</v-btn>
              <v-btn
                v-if="adAccion==2"
            ...
            <v-card-text>
              ...
              <div id="factura">
                <header>
                  ...
                  <div id="datos">
                    <p id="encabezado">
                      <b>Panaderia El Hornito</b>
                      <br>Rafael Herrera 93, Libres - Puebla, Mexico
                      <br>Telefono: (+51)2761015369
                      <br>Email: rafael_h5z@hotmail.es
                    </p>
                  </div>
                  <div id="fact">
                    <p>{{tipo_comprobante}}
        ...
        <v-layout row wrap>
          ...
          <v-flex xs12 sm12 md12 lg12 xl12>
            ...
            >
              <template slot="items" slot-scope="props">
                <td class="justify-center layout px-0">
                  <v-icon @click="eliminarDetalle(detalles, props.item)" small class="mr-2">delete</v-icon>
                </td>
              ...
              <template slot="no-data">
                <h3>No hay articulos agregados</h3>
              </template>
            </v-data-table>
  ...
  methods: {
    ...
    buscarCodigo() {
      ...
      axios
        ...
        .catch(function(error) {
          console.log(error);
          me.errorArticulo = "No esta registrado el articulo";
        });
    },
    ...
    validar() {
      ...
      if (!this.impuesto || this.impuesto <= 0) {
        this.validaMensaje.push("Ingrese el impuesto correcto.");
      }

      if (this.detalles.length <= 0) {
        this.validaMensaje.push("Ingrese almenos un articulo.");
      }
