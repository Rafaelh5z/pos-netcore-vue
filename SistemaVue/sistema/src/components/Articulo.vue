              ...
              <v-container grid-list-md>
                <v-layout wrap>
                  ...
                  <v-flex xs12 sm12 md12>
                    <v-text-field v-model="nombre" label="Nombre del articulo"></v-text-field>
                  </v-flex>
                  <v-flex xs6 sm6 md6>
...
export default {
  ...
  methods: {
    crearPDF() {
      ...
      //en jsPDF se pasa la orientacion en el documento 
      //el valor pt es vertical (porttried) y ld(landscape)
    ...
    validar() {
      ...
      if (this.nombre.length < 3 || this.nombre.length > 50) {
        this.validaMensaje.push(
          "El nombre debe tener mas de 3 letras y menos de 50."
        );
      }
      ...
      if (!this.stock || this.stock == 0) {
        this.validaMensaje.push("Ingresa el stock del articulo.");
      }

      if (!this.precio_venta || this.precio_venta == 0) {
        this.validaMensaje.push("El precio del articulo no puede ser 0.");
      }
